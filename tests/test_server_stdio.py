...
async def test_handshake_lists_tools():
    ...
    assert tools == {"device_info", "server_status", "list_pads", "verify_backup", "restore_procedure",
                     "read_pad", "read_project", "set_pad", "set_slot", "undo_last_pad_change", "chop_sample", "undo_last_chop", "clear_pads", "undo_last_clear", "install_sample", "install_kit", "undo_last_install", "delete_samples", "create_backup", "fetch_reference",
